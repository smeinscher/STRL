...
{
  public:
    STRLBasicMovementPhysics2D(STRLObject *object, STRLEventManager *event_manager, Box2DPhysics *physics,
                               STRLKey up_key = STRL_KEY_W, STRLKey down_key = STRL_KEY_S,
                               STRLKey left_key = STRL_KEY_A, STRLKey right_key = STRL_KEY_D);
  ...
  protected:
    ...
    std::unique_ptr<Box2DBodyData> physics_body_data_;
